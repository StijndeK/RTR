...
## Future developments
The current tool has been made to be as quick and easy to use as possible. Because of which a lot is done in the background. However, there are a lot of interesting possibilities when moving them to the front-end and providing complete controll over how to adapt the riser and to what. Currently, I am working on a beta version that is directly integrated in Unreal Engine (instead of providing a seperate standalone tool and integration plugin).
